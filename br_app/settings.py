...
SECRET_KEY = 'django-insecure--(##ceyr14ro=*80qi4n&w-hli+v6tr%5hoxv9jerp^n(9%*16'
...
WSGI_APPLICATION = 'br_app.wsgi.application'
...
if DB_NAME:
    DATABASES = {
        "default": {
            ...
            "PORT": os.getenv("DB_PORT", "5432"),
            "OPTIONS": {
                "sslmode": "require",   # <- ESSENCIAL no Render
            },
        }
    }
else:
